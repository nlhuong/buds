        ...
        try {
            {
                ...
                for (int kdx = 1; kdx <= Npairs; ++kdx) {
                    ...
                    stan::math::assign(get_base1_lhs(delta,kdx,"delta",1), (bias + (rho * fabs((get_base1(tau,get_base1(i_idx,kdx,"i_idx",1),"tau",1) - get_base1(tau,get_base1(j_idx,kdx,"j_idx",1),"tau",1))))));
